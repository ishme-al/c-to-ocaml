...
let initialize () : myStructure =
  let str : myStructure = { a = 1; b = 2; c = 'a'; d = 3. } in
  str

let combine (str : myStructure) (str2 : myStructure) : myStructure =
  let str3 : myStructure =
    {
      a = Int.( + ) str.a str2.a;
      b = Int.( + ) str.b str2.b;
      c = str.c;
...
let () =
  let str : myStructure = { a = 1; b = 2; c = 'a'; d = 3. } in
  let str2 : myStructure = initialize () in
  let str3 : myStructure = combine str str2 in
